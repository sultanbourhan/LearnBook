...
const Get_Shoole_By_Id = () => {
  ...
  const AllComment =
    getallpost?.filter((item) => id_comment === item._id)[0]?.comments || [];
  ...
  const handleChange = (e) => {
    ...
    inputRef.current.style.height =
      Math.max(inputRef.current.scrollHeight, minHeight) + "px";
  };
                ...
                <div className="profile_all">
                  ...
                  <div className="Frends">
                    ...
                    {GetDataById?.friends?.length > 0 && <div className="img_frend">
                      {GetDataById?.friends?.slice(0, 6).map((friend) => (
                        <img
                          src={
                            friend?.friend?.profilImage
                              ? friend.friend?.profilImage?.startsWith("http")
                                ? friend.friend?.profilImage
                                : `${apiUrl}/user/${friend.friend?.profilImage}`
                              : "/image/pngegg.png"
                          }
                          alt=""
                        />
                    ...
                    {GetDataById?.friends?.length > 0 && <div className="All_frends">
                      <h3>{t('All friends')}</h3>
                      <div className="bax_frends">
                        {GetDataById?.friends?.map((friend) => (
                          <div className="one_frends">
                            <img
                              src={
                                friend?.friend?.profilImage
                                  ? friend.friend?.profilImage?.startsWith(
                                      "http"
                                    )
                                    ? friend.friend?.profilImage
                                    : `${apiUrl}/user/${friend.friend?.profilImage}`
                  ...
                  <div className="buttom_F">
                    ...
                    {GetDataById?.Friend_requests?.some(
                      ...
                      <p>{t('You have sent a friend request')}</p>
                    ) : null}
                          ...
                          <div className="name_shoole">
                            ...
                            <div className="date_shoole">
                              <p>
                                ...
                                {post?.user?.role === "employee" &&
                                post.user.type_of_user ? (
                                  <span
                                    style={{
                                      backgroundColor:
                                        post.user.type_of_user === "School"
                                          ? "rgb(220 252 231)"
                                          : post.user.type_of_user === "Teacher"
                                          ? "rgb(243 232 255)"
                                          : post.user.type_of_user ===
                                            "University"
                                          ? "rgb(219 234 254)"
                                    ...
                                    className="type_user"
                                  >
                                    {post.user?.type_of_user === "School" ? t("School") : 
                        post.user?.type_of_user === "Teacher" ? t("Teacher") :
                          post.user?.type_of_user === "University" ? t("University"):
                            post.user?.type_of_user === "Institution" ? t("Institution"): 
                             post.user?.type_of_user === "Professor" ? t("Professor") : null
                      }
                                  </span>
                                ) : null}{" "}
                              </p>
                          ...
                          <div className="comment_lenght">
                            <p>
                              <span className="testabl" data-post-id={post._id}>
                                {post.likes.length}
                              </span>{" "}
                              {t('Likes')}
                            </p>
                            <div className="comment_like">
                              <p>
                                <span>{post.comments.length}</span> {t('Comments')}
                              </p>
                              <p>{t('shares')}</p>
                            </div>
                          </div>
                            ...
                            <div className="inter">
                              {
                                <div
                                  ...
                                  onClick={(e) => {
                                    ...
                                    const testabl = document.querySelector(
                                      `.testabl[data-post-id="${post._id}"]`
                                    );

                                    if (svg.classList.contains("active_hart")) {
                                      svg.classList.remove("active_hart");
                                      testabl.innerHTML =
                                        Number(testabl.innerHTML) - 1;
                                    } else {
